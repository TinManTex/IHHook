...
exportInfo=[
	...
	{"name":"GetStrCodeWithLength","usingDetour":True,},
	{"name":"GetStrCode32","usingDetour":True,},
	{"name":"PathCode64Ext","usingDetour":True, 
	...
	{"name":"Path_Copy", "usingDetour":True,},
	{"name":"GetEmptyPath", "usingDetour":True,},
	...
	{"name":"LoadBuddyDogCommonFPK", "usingDetour":True,},
	{"name":"LoadBuddyHorseCommonFPK", "usingDetour":True,},
	#{"name":"LoadBuddyWalkerGearCommonFPK", "usingDetour":True,},
	...
	{"name":"foxlua::NewSubModule", "debugOnly":True,},
	{"name":"foxlua::AddCFuncToModule", "debugOnly":True,},
	{"name":"foxlua::AddCFuncToModule2", "debugOnly":True,},
	{"name":"foxlua::AddCFuncToModule3", "debugOnly":True,},
	{"name":"foxlua::AddEnumToModule", "debugOnly":True,},
	{"name":"foxlua::AddEnumToModule2", "debugOnly":True,},
	{"name":"foxlua::AddEnumToModule3", "debugOnly":True,},
	{"name":"foxlua::AddEnumToModule4", "debugOnly":True,},
	...
	{"name":"lua::lua_newstate", "usingDetour":True, 
		"note":"tex could use default implementation, but may want to hook if we want to see what the engine is up to"},
	{"name":"lua::lua_close",},
	{"name":"lua::lua_newthread", "usingDetour":True,},

	{"name":"lua::lua_atpanic", "usingDetour":True,},
	...
	{"name":"lua::lua_call",},
	{"name":"lua::lua_pcall", "usingDetour":True,},
	{"name":"lua::lua_cpcall", "usingDetour":True,},
	{"name":"lua::lua_load", "usingDetour":True,},
	...
	{"name":"lua::lua_gc",},
	{"name":"lua::lua_error", "usingDetour":True,},
	...
	{"name":"lua::luaL_loadbuffer", "usingDetour":True,},
	...
	{"name":"lua::luaL_openlibs","usingDetour":True,},
	#luaLib.h<
]#exportInfo
