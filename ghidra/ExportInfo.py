...
exportInfo=[
	...
	{"name":"GetStrCodeWithLength","usingHook":True,},#TODO: namespace
	...
	#{"name":"FNVHash64",},
	{"name":"ui::lang::GetFreeRoamLangId", "usingHook":True,},
	...
	{"name":"files::LoadFile", "usingHook":True,},
	{"name":"files::LoadFileSub", "usingHook":True,},
	{"name":"Path_Copy",},#TODO: namespace
	{"name":"fox::PathManager::GetEmptyPath", "usingHook":True,},
    
	{"name":"player::appearance::parts::LoadPlayerPartsFpk", "usingHook":True,},
	...
	{"name":"player::appearance::fova::skinTone::LoadPlayerPartsSkinToneFv2", "usingHook":True,},
	{"name":"player::appearance::IsHeadNeededForPartsType", "usingHook":True,},
	{"name":"player::appearance::IsHeadNeededForPartsTypeAndAvatar", "usingHook":True,},
	{"name":"player::appearance::fova::face::LoadPlayerSnakeFaceFpk", "usingHook":True,},
	{"name":"player::appearance::fova::face::LoadPlayerSnakeFaceFv2", "usingHook":True,},
	{"name":"player::appearance::avatar::LoadAvatarOgreHornFpk", "usingHook":True,},
	{"name":"player::appearance::avatar::LoadAvatarOgreHornFv2", "usingHook":True,},
	{"name":"buddy::system::LoadBuddyMainFile", "usingHook":True,},
	#{"name":"buddy::system::LoadBuddySubFileFpk", "usingHook":True, "note":"exploration"},
	{"name":"buddy::quiet::LoadBuddyQuietWeaponFpk", "usingHook":True,},
	{"name":"buddy::dog::LoadBuddyDogCommonFPK", "usingHook":True,},
	{"name":"buddy::horse::LoadBuddyHorseCommonFPK", "usingHook":True,},
	#{"name":"buddy::walker::LoadBuddyWalkerGearCommonFPK", "usingHook":True,},
	{"name":"buddy::walker::LoadBuddyWalkerGearArmFpk", "usingHook":True,},
	{"name":"buddy::walker::LoadBuddyWalkerGearHeadFpk", "usingHook":True,},
	{"name":"buddy::walker::LoadBuddyWalkerGearWeaponFpk", "usingHook":True,},
	{"name":"FileLoadDefaultCommon::LoadDefaultFpksFunc"},
	{"name":"vehicle::appearance::PreparePlayerVehicleInSortie", "usingHook":True,},
	{"name":"vehicle::appearance::PreparePlayerVehicleInGame", "usingHook":True,},
	{"name":"FileLoadDefaultCommon::LoadDefaultFpkPtrFunc"},
	{"name":"vehicle::appearance::camo::LoadAllVehicleCamoFpks"},
	{"name":"player::callMenu::BuddyCommandGetNameLangId"},
	{"name":"player::callMenu::BuddyCommandGetDescriptionLangId"},
