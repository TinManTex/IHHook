...
END_BOOL_POINTER(v)
END_IMGUI_FUNC
//    IMGUI_API bool		  CheckboxFlags(const char* label, unsigned int* flags, unsigned int flags_value) //tex changed int to unsigned
...
IMGUI_FUNCTION_DRAW_LIST(GetClipRectMin)
DRAW_LIST_CALL_FUNCTION(GetClipRectMin, ImVec2)
PUSH_NUMBER(ret.x)
PUSH_NUMBER(ret.y)
END_IMGUI_FUNC
//    inline ImVec2   GetClipRectMax() const { const ImVec4& cr = _ClipRectStack.back(); return ImVec2 cr.z  cr.w; }
IMGUI_FUNCTION_DRAW_LIST(GetClipRectMax)
DRAW_LIST_CALL_FUNCTION(GetClipRectMax, ImVec2)
PUSH_NUMBER(ret.x)
PUSH_NUMBER(ret.y)
END_IMGUI_FUNC
...
IMGUI_FUNCTION_DRAW_LIST(PathClear)
DRAW_LIST_CALL_FUNCTION_NO_RET(PathClear)
END_IMGUI_FUNC
//    inline    void  PathLineTo(const ImVec2& pos)                               { _Path.push_back(pos); }
IMGUI_FUNCTION_DRAW_LIST(PathLineTo)
IM_VEC_2_ARG(pos)
DRAW_LIST_CALL_FUNCTION_NO_RET(PathLineTo, pos)
END_IMGUI_FUNC
//    inline    void  PathLineToMergeDuplicate(const ImVec2& pos)                 { if (_Path.Size == 0 || memcmp(&_Path.Data[_Path.Size - 1], &pos, 8) != 0) _Path.push_back(pos); }
IMGUI_FUNCTION_DRAW_LIST(PathLineToMergeDuplicate)
IM_VEC_2_ARG(pos)
DRAW_LIST_CALL_FUNCTION_NO_RET(PathLineToMergeDuplicate, pos)
END_IMGUI_FUNC
//    inline    void  PathFillConvex(ImU32 col)                                   { AddConvexPolyFilled(_Path.Data, _Path.Size, col); _Path.Size = 0; }  // Note: Anti-aliased filling requires points to be in clockwise order.
IMGUI_FUNCTION_DRAW_LIST(PathFillConvex)
UINT_ARG(col)
DRAW_LIST_CALL_FUNCTION_NO_RET(PathFillConvex, col)
END_IMGUI_FUNC
//    inline    void  PathStroke(ImU32 col, bool closed, float thickness = 1.0f)  { AddPolyline(_Path.Data, _Path.Size, col, closed, thickness); _Path.Size = 0; }
IMGUI_FUNCTION_DRAW_LIST(PathStroke)
UINT_ARG(col)
BOOL_ARG(closed)
OPTIONAL_NUMBER_ARG(thickness, 1.0f)
DRAW_LIST_CALL_FUNCTION_NO_RET(PathStroke, col, closed, thickness)
END_IMGUI_FUNC
...
INT_ARG(count)
DRAW_LIST_CALL_FUNCTION_NO_RET(ChannelsSplit, count)
END_IMGUI_FUNC
...
INT_ARG(n)
DRAW_LIST_CALL_FUNCTION_NO_RET(ChannelsSetCurrent, n)
END_IMGUI_FUNC
...
IMGUI_FUNCTION_DRAW_LIST(PrimWriteVtx)
IM_VEC_2_ARG(pos)
IM_VEC_2_ARG(uv)
UINT_ARG(col)
DRAW_LIST_CALL_FUNCTION_NO_RET(PrimWriteVtx, pos, uv, col)
END_IMGUI_FUNC
//    inline    void  PrimWriteIdx(ImDrawIdx idx)                                     { *_IdxWritePtr = idx; _IdxWritePtr++; }
// Unsupported arg type ImDrawIdx idx
//    inline    void  PrimVtx(const ImVec2& pos, const ImVec2& uv, ImU32 col)         { PrimWriteIdx((ImDrawIdx)_VtxCurrentIdx); PrimWriteVtx(pos, uv, col); } // Write vertex with unique index
IMGUI_FUNCTION_DRAW_LIST(PrimVtx)
IM_VEC_2_ARG(pos)
IM_VEC_2_ARG(uv)
UINT_ARG(col)
