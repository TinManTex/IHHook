...
HOOKPTR(lua_close, 0x141a21660);//14c1fc380
HOOKPTR(lua_newthread, 0x14bcdc650);//14c1d9d90
...
HOOKPTR(lua_tointeger, 0x14c1ec760);//1.0.15.2 = 0x14bce55d0);//MINIMAL_HOOK
HOOKPTR(lua_toboolean, 0x14bce4ef0);
HOOKPTR(lua_tolstring, 0x14c1eca70);//1.0.15.2 = 0x14bce5830);//MINIMAL_HOOK
...
*/
HOOKPTR(lua_pushnil, 0x14c1e7cc0);//1.0.15.2 = 0x14bcded30);//MINIMAL_HOOK //DEBUGNOW
HOOKPTR(lua_pushnumber, 0x14bcdf650);
HOOKPTR(lua_pushinteger, 0x14c1e6ef0);//1.0.15.2 = 0x14bcde010);//MINIMAL_HOOK
HOOKPTR(lua_pushlstring, 0x14bcdea10);
HOOKPTR(lua_pushstring, 0x14c1e7ee0);//1.0.15.2 = 0x14bcdf720);//MINIMAL_HOOK
HOOKPTR(lua_pushvfstring, 0x14bce0dd0);
HOOKPTR(lua_pushfstring, 0x14bcddd20);
HOOKPTR(lua_pushcclosure, 0x14bcdd990);
HOOKPTR(lua_pushboolean, 0x14c1db230);//1.0.15.2 = 0x14bcdd750);//MINIMAL_HOOK
...
HOOKPTR(lua_getfield, 0x14c1d7320);//1.0.15.2 = 0x14bcda4e0);//MINIMAL_HOOK
HOOKPTR(lua_rawget, 0x14bce1580);
HOOKPTR(lua_rawgeti, 0x14bce17e0);//MACRO lua_getref
HOOKPTR(lua_createtable, 0x14c1d6320);//1.0.15.2 = 0x14bcd9080);//MINIMAL_HOOK //DEBUGNOW
...
HOOKPTR(lua_setfield, 0x14c1eabb0);//1.0.15.2 = 0x14bce37a0);//MINIMAL_HOOK
HOOKPTR(lua_rawset, 0x14bce1d00);
HOOKPTR(lua_rawseti, 0x14c1e9ff0);//1.0.15.2 = 0x14bce2020);//MINIMAL_HOOK
