...
namespace IHHook {
	...
	void SetFuncPtrs() {
		...
		funcPtrPtrs["GetFreeRoamLangId"] = &GetFreeRoamLangId;
		...
		funcPtrPtrs["LoadFile"] = &LoadFile;
		LoadFileSub = (LoadFileSubFunc*)addressSet["LoadFileSub"];
		funcPtrPtrs["LoadFileSub"] = &LoadFileSub;
